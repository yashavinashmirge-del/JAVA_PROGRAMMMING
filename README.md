...
| 09 | program09 | Program to calculate separate sums for even and odd digits of a number | Java | Combining digit extraction loops with conditional (`if-else`) logic inside, multi-variable tracking | [View Code](./CP_CODES/program9.java)|
| 10 | program10 | Program to check whether a number is positive, negative, or zero | Java | Multi-way branching using `if - else if - else` control flows | [View Code](./CP_CODES/program10.java)|
...
| 07 | program40 | 	Take a number input from user and check is  number is not divisible by 3 & 5 |	JAVA_Programming|	check divisiblity [Type2] / Error  a static reference to the non-static method CheckDivisible(int) | [View Code](./PRACTICE_CODES/program40.java) |
| 08 | program41 | 	Take a number input from user and check is  number is not divisible by 3 & 5  |	JAVA_Programming|	check divisiblity [Type3] / function should be static to call it from main without creating the object   | [View Code](./PRACTICE_CODES/program41.java) |
| 09 | program42 | 	Take a number input from user and check is  number is not divisible by 3 & 5 |	JAVA_Programming|	check divisiblity [Type2] / function should be static and public  to call it from main without creating the object  | [View Code](./PRACTICE_CODES/program42.java) |
| 10 | program43 | 	Take a number input from user and check is  number is not divisible by 3 & 5 |	JAVA_Programming|	check divisiblity [Type2] optimize code  | [View Code](./PRACTICE_CODES/program43.java) |
| 11 | program44 | 	Take a number input from user and check is  number is not divisible by 3 & 5 |	JAVA_Programming|	check divisiblity [Type3] optimize code with Business Logic in different class  | [View Code](./PRACTICE_CODES/program44.java) |
| 12 | program45 | 	Take a number input from user and check is  number is not divisible by 3 & 5 |	JAVA_Programming|	check divisiblity [Type3] / optimize code with Business Logic in different class / Method Calling using Object | [View Code](./PRACTICE_CODES/program45.java) |
| 13 | program46 | 	Take a number input and Display its Factors |	JAVA_Programming |	normal code with  Business Logic in different class [  Time Complexity : O(N) ]  | [View Code](./PRACTICE_CODES/program46.java) |
| 14 | program47 | 	Take a number input and Display its Factors |	JAVA_Programming |	normal code with  Business Logic in different class [  Time Complexity : O(N/2) ]  | [View Code](./PRACTICE_CODES/program47.java) |
| 15 | program48 | 	Take a number input and Summation of factors |	JAVA_Programming |	normal code with  Business Logic in different class  | [View Code](./PRACTICE_CODES/program48.java) |
